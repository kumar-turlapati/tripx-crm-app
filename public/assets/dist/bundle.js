...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddItems = __webpack_require__(/*! ./AddItems/AddItems.jsx */ 168);
	
	var _AddItems2 = _interopRequireDefault(_AddItems);
	
	var _AddItemsPurchase = __webpack_require__(/*! ./AddItemsPurchase/AddItemsPurchase.jsx */ 205);
	
	var _AddItemsPurchase2 = _interopRequireDefault(_AddItemsPurchase);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var salesElement = document.getElementById('salesentry');
	if (typeof salesElement != 'undefined' && salesElement != null) {
		_reactDom2.default.render(_react2.default.createElement(_AddItems2.default, null), salesElement);
	}
	
	var purchElement = document.getElementById('purchentry');
	if (typeof purchElement != 'undefined' && purchElement != null) {
		_reactDom2.default.render(_react2.default.createElement(_AddItemsPurchase2.default, null), purchElement);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemRow = __webpack_require__(/*! ../ItemRow/ItemRow.jsx */ 169);
	...
	var AddItems = function (_Component) {
		...
		function AddItems() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(AddItems)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				itemRows: []
			}, _this.componentWillMount = function () {
				_this.addItem();
			}, _this.getNextUniqueKey = function () {
				if (!_this.generatedUniqueId) _this.generatedUniqueId = 0;
				_this.generatedUniqueId++;
				return _this.generatedUniqueId;
			}, _this.addItem = function () {
				var itemRows = _this.state.itemRows;
				var uniqueKey = _this.getNextUniqueKey();
				var keyIndex = itemRows.length > 0 ? uniqueKey : 0;
	
				itemRows[keyIndex] = _react2.default.createElement(_ItemRow2.default, { key: uniqueKey, removeHandler: _this.removeItem, rowID: keyIndex });
				_this.setState({
					itemRows: itemRows
				});
			}, _this.removeItem = function (rowID, evt) {
				var itemRows = _this.state.itemRows;
				if (rowID > 0) {
					itemRows[rowID] = null;
					_this.setState({
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ className: 'btn btn-link', onClick: this.addItem.bind(this) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AutoComplete = __webpack_require__(/*! ../AutoComplete/AutoComplete.jsx */ 170);
	...
	var ItemRow = function (_Component) {
	  ...
	  function ItemRow() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ItemRow).apply(this, arguments));
	  }
	  ...
	  _createClass(ItemRow, [{
	    ...
	    value: function render() {
	      ...
	      var itemQty = function itemQty() {
	        var itemOptions = [];
	        itemOptions.push(_react2.default.createElement(
	          'option',
	          { value: 0, key: 0 },
	          'Choose'
	        ));
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_AutoComplete2.default, {
	            fetchURL: 'http://api.amc.local/products/ac',
	            elementName: 'itemDetails[itemName][]',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'select',
	              { className: 'form-control', name: 'itemDetails[itemQty][]' },
	              itemQty()
	            )
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'select',
	              { className: 'form-control', name: 'itemDetails[batchNo][]' },
	              _react2.default.createElement(
	                'option',
	                null,
	                'Choose'
	        ...
	        _react2.default.createElement(
	          'td',
	          null,
	          rowID > 1 ? _react2.default.createElement(
	            'button',
	            { className: 'btn btn-danger', onClick: function onClick(evt) {
	                return removeHandler(rowID, evt);
	              } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAutosuggest = __webpack_require__(/*! react-autosuggest */ 171);
	...
	var AutoComplete = function (_Component) {
	  ...
	  function AutoComplete() {
	    ...
	    _this.onSuggestionsUpdateRequested = function (_ref2) {
	      ...
	      var newSuggestions = _this.getSuggestions(value);
	      _this.setState({
	          ...
	          xhttp.onreadystatechange = function () {
	            if (xhttp.readyState == 4 && xhttp.status == 200) {
	              ...
	              for (var i in responseObject) {
	                json.push(responseObject[i]);
	              }
	              newSuggestions = json;
	            }
	          };
	          xhttp.open("GET", _this.props.fetchURL + '?q=' + inputValue, true);
	          xhttp.send();
	        })();
	      }
	...
	AutoComplete.propTypes = {
	  fetchURL: _react.PropTypes.string.isRequired,
	  elementName: _react.PropTypes.string.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./AutosuggestContainer */ 172).default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerAndActions = __webpack_require__(/*! ./reducerAndActions */ 186);
	
	var _reducerAndActions2 = _interopRequireDefault(_reducerAndActions);
	
	var _Autosuggest = __webpack_require__(/*! ./Autosuggest */ 187);
...
/* 173 */
/*!**************************************************!*\
  !*** ./~/react-autosuggest/~/redux/lib/index.js ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 174 */
/*!********************************************************!*\
  !*** ./~/react-autosuggest/~/redux/lib/createStore.js ***!
  \********************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 175 */
/*!***************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/~/lodash/isPlainObject.js ***!
  \***************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 176 */
/*!***************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/~/lodash/_getPrototype.js ***!
  \***************************************************************/
/***/ function(module, exports) {
...
/* 177 */
/*!***************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/~/lodash/_isHostObject.js ***!
  \***************************************************************/
/***/ function(module, exports) {
...
/* 178 */
/*!**************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/~/lodash/isObjectLike.js ***!
  \**************************************************************/
/***/ function(module, exports) {
...
/* 179 */
/*!******************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/~/symbol-observable/index.js ***!
  \******************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 180 */
/*!*********************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/~/symbol-observable/ponyfill.js ***!
  \*********************************************************************/
/***/ function(module, exports) {
...
/* 181 */
/*!************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/lib/combineReducers.js ***!
  \************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 182 */
/*!**********************************************************!*\
  !*** ./~/react-autosuggest/~/redux/lib/utils/warning.js ***!
  \**********************************************************/
/***/ function(module, exports) {
...
/* 183 */
/*!***************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/lib/bindActionCreators.js ***!
  \***************************************************************/
/***/ function(module, exports) {
...
/* 184 */
/*!************************************************************!*\
  !*** ./~/react-autosuggest/~/redux/lib/applyMiddleware.js ***!
  \************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 185 */
/*!****************************************************!*\
  !*** ./~/react-autosuggest/~/redux/lib/compose.js ***!
  \****************************************************/
/***/ function(module, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAutowhatever = __webpack_require__(/*! react-autowhatever */ 201);
...
/* 188 */
/*!********************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/lib/index.js ***!
  \********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _connect = __webpack_require__(/*! ./components/connect */ 192);
...
/* 189 */
/*!**********************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/lib/components/Provider.js ***!
  \**********************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(/*! ../utils/storeShape */ 190);
...
/* 190 */
/*!*******************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/lib/utils/storeShape.js ***!
  \*******************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 191 */
/*!****************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/lib/utils/warning.js ***!
  \****************************************************************/
/***/ function(module, exports) {
...
/* 192 */
/*!*********************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/lib/components/connect.js ***!
  \*********************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _shallowEqual = __webpack_require__(/*! ../utils/shallowEqual */ 193);
	
	var _shallowEqual2 = _interopRequireDefault(_shallowEqual);
	
	var _wrapActionCreators = __webpack_require__(/*! ../utils/wrapActionCreators */ 194);
...
/* 193 */
/*!*********************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/lib/utils/shallowEqual.js ***!
  \*********************************************************************/
/***/ function(module, exports) {
...
/* 194 */
/*!***************************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/lib/utils/wrapActionCreators.js ***!
  \***************************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 195 */
/*!*********************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/~/lodash/isPlainObject.js ***!
  \*********************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 196 */
/*!*********************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/~/lodash/_getPrototype.js ***!
  \*********************************************************************/
/***/ function(module, exports) {
...
/* 197 */
/*!*********************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/~/lodash/_isHostObject.js ***!
  \*********************************************************************/
/***/ function(module, exports) {
...
/* 198 */
/*!********************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/~/lodash/isObjectLike.js ***!
  \********************************************************************/
/***/ function(module, exports) {
...
/* 199 */
/*!******************************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/~/hoist-non-react-statics/index.js ***!
  \******************************************************************************/
/***/ function(module, exports) {
...
/* 200 */
/*!******************************************************************!*\
  !*** ./~/react-autosuggest/~/react-redux/~/invariant/browser.js ***!
  \******************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 201 */
/*!***********************************************************************!*\
  !*** ./~/react-autosuggest/~/react-autowhatever/dist/Autowhatever.js ***!
  \***********************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _sectionIterator = __webpack_require__(/*! section-iterator */ 202);
	
	var _sectionIterator2 = _interopRequireDefault(_sectionIterator);
	
	var _reactThemeable = __webpack_require__(/*! react-themeable */ 203);
...
/* 202 */
/*!***********************************************************************************!*\
  !*** ./~/react-autosuggest/~/react-autowhatever/~/section-iterator/dist/index.js ***!
  \***********************************************************************************/
/***/ function(module, exports) {
...
/* 203 */
/*!**********************************************************************************!*\
  !*** ./~/react-autosuggest/~/react-autowhatever/~/react-themeable/dist/index.js ***!
  \**********************************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectAssign = __webpack_require__(/*! object-assign */ 204);
...
/* 204 */
/*!*********************************************************************************************!*\
  !*** ./~/react-autosuggest/~/react-autowhatever/~/react-themeable/~/object-assign/index.js ***!
  \*********************************************************************************************/
/***/ function(module, exports) {
...
/* 205 */
/*!***********************************************!*\
  !*** ./AddItemsPurchase/AddItemsPurchase.jsx ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemRowPurchase = __webpack_require__(/*! ../ItemRowPurchase/ItemRowPurchase.jsx */ 206);
	
	var _ItemRowPurchase2 = _interopRequireDefault(_ItemRowPurchase);
	...
	var AddItemsPurchase = function (_Component) {
		_inherits(AddItemsPurchase, _Component);
	
		function AddItemsPurchase() {
			var _Object$getPrototypeO;
	
			var _temp, _this, _ret;
	
			_classCallCheck(this, AddItemsPurchase);
	
			for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
				args[_key] = arguments[_key];
			}
	
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(AddItemsPurchase)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				itemRows: []
			}, _this.componentWillMount = function () {
				_this.addItem();
			}, _this.getNextUniqueKey = function () {
				...
				itemRows[keyIndex] = _react2.default.createElement(_ItemRowPurchase2.default, { key: uniqueKey, removeHandler: _this.removeItem, rowID: keyIndex });
				_this.setState({
					itemRows: itemRows
				});
			}, _this.removeItem = function (rowID, evt) {
		...
		return AddItemsPurchase;
	}(_react.Component);
	
	exports.default = AddItemsPurchase;

/***/ },
/* 206 */
/*!*********************************************!*\
  !*** ./ItemRowPurchase/ItemRowPurchase.jsx ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemRowPurchase = function (_Component) {
	  _inherits(ItemRowPurchase, _Component);
	
	  function ItemRowPurchase() {
	    _classCallCheck(this, ItemRowPurchase);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ItemRowPurchase).apply(this, arguments));
	  }
	
	  _createClass(ItemRowPurchase, [{
	    key: 'render',
	    value: function render() {
	      var removeHandler = this.props.removeHandler;
	      var rowID = this.props.rowID;
	      ...
	      var taxPercent = function taxPercent() {
	        var taxPercents = [];
	        taxPercents.push(_react2.default.createElement(
	          'option',
	          { value: 0, key: 0 },
	          'Nil'
	        ));
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'select',
	              { className: 'form-control', name: 'itemDetails[inwardQty][]' },
	              itemQty()
	            )
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'select',
	              { className: 'form-control', name: 'itemDetails[freeQty][]' },
	              itemQty()
	            )
	          )
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          _react2.default.createElement('input', { type: 'text', name: 'itemDetails[batchNo][]' })
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          _react2.default.createElement('input', { type: 'text', name: 'itemDetails[expDate][]' })
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          _react2.default.createElement('input', { type: 'text', name: 'itemDetails[mrp][]' })
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          _react2.default.createElement('input', { type: 'text', name: 'itemDetails[itemRate][]' })
	        ),
	        _react2.default.createElement(
	          'td',
	          null,
	          _react2.default.createElement(
	            'select',
	            { className: 'form-control', name: 'itemDetails[taxPercent][]' },
	            taxPercent()
	          )
	        ),
	        _react2.default.createElement(
	  ...
	  return ItemRowPurchase;
	}(_react.Component);
	
	ItemRowPurchase.propTypes = {
	  removeHandler: _react.PropTypes.func.isRequired
	};
	exports.default = ItemRowPurchase;

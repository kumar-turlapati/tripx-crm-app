...
<div class="row">
  <div class="col-lg-12"> 
    ...
    <!-- Panel starts -->
    <section class="panel">
      <h2 class="hdg-reports text-center">Create a Coupon</h2>
      <div class="panel-body">
        ...
        <div class="global-links actionButtons clearfix">
          <div class="pull-right text-right">
            <a href="/promo-offers/list" class="btn btn-default">
              <i class="fa fa-book"></i> Coupons List
            </a>
          </div>
        </div>
        <!-- Right links ends --> 
        ...
        >
          <div class="form-group">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 m-bot15">
              <label class="control-label">Coupon platform</label>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 m-bot15">
              <label class="control-label">Coupon description (250 characters maximum)</label>
              <input
                type="text"
                class="form-control noEnterKey"
                name="offerDesc"
          ...
          <div class="form-group">
            <div class="col-sm-12 col-md-4 col-lg-4 m-bot15">
              <label class="control-label">How many impressions are allowed?</label>
              <input
                type="text"
                class="form-control noEnterKey"
                name="offerDesc"

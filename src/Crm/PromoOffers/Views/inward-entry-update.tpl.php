          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover item-detail-table font11" id="purchaseTable">
              ...
              ?>
                ...
                <tr>
                  <td colspan="9" align="right" style="vertical-align:middle;font-weight:bold;font-size:14px;">Total taxable amount</td>
                ...
                <?php if( is_array($taxes_raw) && count($taxes_raw)>0 ): ?>
                  ...
                  ?>
                    <tr>
                      <td colspan="9" align="right" style="vertical-align:middle;font-weight:bold;font-size:14px;">(+) <?php echo $tax_label ?></td>
                ...
                <?php endif;?>
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;font-size:14px;" colspan="9" align="right">(+) Other taxes</td>
                ...
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;font-size:14px;" colspan="9" align="right">(+) Freight / Shipping charges</td>
                ...
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;font-size:14px;" colspan="9" align="right">Grand total</td>
                  <td style="vertical-align:middle;text-align:right;font-size:14px;" id="inwTotalAmount"><?php echo round($grand_total,2) ?></td>
                </tr>
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;font-size:14px;" colspan="9" align="right">(+/-) Adjustments</td>
                ...
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;font-size:14px;" colspan="9" align="right">Round off</td>
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;text-align:right;" colspan="9">
                    <textarea
                      class="form-control noEnterKey"
                      rows="3"
                      cols="100"
